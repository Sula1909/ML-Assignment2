...
კონკურსის მიზანია თითოეული ტრანზაქციისთვის `isFraud` კლასის, ანუ სიყალბის პროგნოზირება. ამოცანაში მოცემული დატა არის საკმაოდ დაუბალანსებელი, რადგან ცოტაა ყალბი ტრანზაქციების პროცენტულობა. ამ competition-ის მთავარი მეტრიკა კი არის ROC-AUC.  
